...
export default function UnauthorizedPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-50 p-6 text-center">
      ...
      <h1 className="mt-6 text-3xl font-bold tracking-tight">Tu rol no tiene acceso al POS</h1>
      <p className="mt-3 max-w-md text-gray-600">
        Solo los roles CAJERO, ADMIN_OPERATIVO y DUENO pueden operar la caja.
      </p>
      <Link
        href="/login"
