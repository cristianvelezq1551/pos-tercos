...
describe('resolvePocketSplit', () => {
  ...
  it('default redondea el total a peso entero', () => {
  ...
  it('redondea el efectivo a peso entero (10.4 → 10) y la cuenta toma el resto', () => {
    expect(resolvePocketSplit(10.4, undefined, 50)).toEqual({ cash: 10, bank: 40 });
  });

  it('reparto explícito por bolsillo que suma exacto el total (peso entero)', () => {
    expect(resolvePocketSplit(33_000, 33_000, 66_000)).toEqual({ cash: 33_000, bank: 33_000 });
  });
