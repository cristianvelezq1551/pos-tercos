...
export default function UnauthorizedPage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-900 p-6 text-center text-white">
      ...
      <h1 className="mt-6 text-3xl font-bold tracking-tight">Tu rol no tiene acceso a Cocina</h1>
      <p className="mt-3 max-w-md text-gray-300">
        Solo los roles COCINERO, ADMIN_OPERATIVO y DUENO pueden operar el KDS.
      </p>
      <Link
        href="/login"
