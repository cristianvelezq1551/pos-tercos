  ...
  ({ className, children, ...rest }, ref) => (
    <div className="relative">
      <select
        ref={ref}
        className={cn(
          'flex h-10 w-full appearance-none rounded-md border border-input bg-card pl-3 pr-9 py-2 text-sm text-foreground transition-colors duration-150 ease-out',
