...
const baseClass = cn(
  'flex h-10 w-full rounded-md border border-input bg-card px-3 py-2 text-base sm:text-sm text-foreground tabular transition-colors duration-150 ease-out',
