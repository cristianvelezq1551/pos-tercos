...
| 2 | **Caja: abrir offline** | Se **permite abrir caja offline** (caja provisional local) + reconciliar. **⏸️ DIFERIDA (B.4b)**: requiere refactor del gate de turno SSR → cliente (toca el arranque online). Limitación vigente: la caja se abre **con conexión**; el corte mid-jornada ya está cubierto. |
