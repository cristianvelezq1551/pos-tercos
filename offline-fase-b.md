...
| **B.2.2b** | **Ledger local en el POS**: cachear el snapshot + descontar insumos por venta offline (`expandRecipe`) + catálogo lee disponibilidad de IndexedDB offline. | Offline: tras N ventas, un preparado se marca agotado. |
